    ...
    <nav className={`${navBg} sticky top-0 z-50 transition-colors`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-18">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a href="#marketplace" className={`text-[13px] font-medium ${linkColor} transition`}>Marketplace</a>
      ...
      {open && (
        <div className={`md:hidden px-4 pb-4 space-y-1 ${dark ? 'bg-navy-900 border-t border-white/10' : 'bg-white border-t border-navy-100'}`}>
          ...
          <a href="#marketplace" className={`block py-2.5 text-sm font-medium ${linkColor}`} onClick={() => setOpen(false)}>Marketplace</a>
