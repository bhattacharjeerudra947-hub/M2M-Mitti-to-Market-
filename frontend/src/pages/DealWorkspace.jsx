                ...
                <div className="space-y-5">
                  ...
                  <div className="bg-white rounded-2xl border border-navy-100 shadow-sm p-5">
                    <div className="flex items-center justify-between mb-3">
                      <p className="text-xs text-gray-400 uppercase font-medium tracking-wide">Logistics</p>
                      {logistics?.type && (
                    ...
                    {logistics ? (
                      ...
                      <p className="text-sm text-gray-500">
                        {['LOCKED', 'LOGISTICS_PENDING'].includes(deal.status)
                          ? 'Logistics not selected yet — choose Own or Mitti2Market logistics from the chat.'
