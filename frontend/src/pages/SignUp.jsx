...
export default function SignUp() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(false);
    if (result.ok) {
navigate(form.role === 'admin' ? '/admin' : form.role === 'farmer' ? '/farmer' : '/business', { replace: true });
    } else {
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                {[{ value: 'farmer', emoji: '👨‍🌾', label: 'Farmer' }, { value: 'business', emoji: '🏪', label: 'Business' }, { value: 'admin', emoji: '🛡️', label: 'Admin' }].map((r) => (
