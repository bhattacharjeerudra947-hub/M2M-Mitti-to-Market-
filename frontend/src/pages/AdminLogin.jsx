...
/**
 * Admin Login Portal — only accepts ADMIN accounts.
 * The role is fixed; the user cannot switch to another portal from here.
 * Admin portal is a separate privileged system — normal users must never reach it.
 */
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="max-w-md mx-auto">
          <div className="text-center mb-6">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-emerald-50 rounded-full text-sm font-medium text-emerald-800 border border-emerald-200 mb-4">
              <span className="text-xl">🛡️</span> Admin Login Portal
            </div>
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Sign In — Admin</h1>
            <p className="text-gray-500">Only platform administrators can sign in here</p>
          </div>
          ...
          <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button type="submit" disabled={loading} className="w-full py-3.5 bg-emerald-700 text-white font-semibold rounded-xl hover:bg-emerald-800 transition shadow-sm flex items-center justify-center gap-2 disabled:opacity-60">
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-gray-500">
                Admin access only.{' '}
                <Link to="/login" className="text-navy-700 font-semibold hover:underline">Back to main login</Link>
              </p>
            </div>
          </div>

          <div className="mt-4 flex flex-wrap gap-2 justify-center text-xs text-gray-500">
            <Link to="/farmer/login" className="px-3 py-1.5 bg-white border border-gray-200 rounded-lg hover:bg-gray-50 transition">Farmer Login</Link>
